...
public class HajjOperatorInfo extends Activity {
	
	 private static String TAG = HajjOperatorInfo.class.getSimpleName();

	 // json object response url
    private String urlJsonObj = "http://labbayak.begoniainfosys.in/api/get/operators";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewoperations.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
	        	...
	        	prefs.edit().putString("ClassName", "HajjOperationInfo").commit();

	        	prefs.edit().putString("HajjOperation_Name", arrayList.get(position).getName()).commit();
	        	prefs.edit().putString("HajjOperation_City", arrayList.get(position).getCity()).commit();

	        	prefs.edit().putString("HajjOperation_Mobile", arrayList.get(position).getMobile()).commit();

	        	prefs.edit().putString("HajjOperation_Email", arrayList.get(position).getEmail()).commit();

	        	
	        	Intent i=new Intent(getApplicationContext(), OperationDeatails.class);
	        	startActivity(i);
	                    ...
	                    public void onResponse(JSONObject response) {
	                        ...
	                        try {
								 ...
								 while (iter.hasNext()) {
										...
										Toast.makeText(HajjOperatorInfo.this,failure,
													Toast.LENGTH_LONG).show();

										}else if(key.equalsIgnoreCase("")){
											
											JSONArray cast = jobj.getJSONArray("operators");
